...
sudo scutil --set ComputerName "Lapdog Pro"
sudo scutil --set HostName "Lapdog Pro"
sudo scutil --set LocalHostName "Lapdog-Pro"
sudo defaults write /Library/Preferences/SystemConfiguration/com.apple.smb.server NetBIOSName -string "Lapdog-Pro"
